...
nonproduction_account_id = "817963804345"
#
clusters = {
  cn-northwest-1 = {
    "eks-02-prod-china" = {
      description = "Production cluster in China region"
      teams       = []
    }
  }
}
...
terraform_state_bucket         = "s3-tf-state-sc-prod-china"
terraform_state_bucket_kms_key = "alias/s3-tf-state-sc-prod-china"
