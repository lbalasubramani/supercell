### GENERAL ###
name                      = "eks-02-nonprod-china"
ingress_nginx_domain_name = "eks-02-nonprod.labycore.cn"

### VPC ###
vpc_cidr               = "10.157.0.0/16"
vpc_azs                = ["cn-northwest-1a", "cn-northwest-1b", "cn-northwest-1c"]
vpc_private_subnets    = ["10.157.4.0/23", "10.157.6.0/23", "10.157.8.0/23"]
vpc_pod_subnets        = ["10.157.16.0/20", "10.157.32.0/20", "10.157.48.0/20"]
vpc_team_subnets       = ["10.157.72.0/21", "10.157.80.0/21", "10.157.88.0/21"]
vpc_public_subnets     = ["10.157.0.0/24", "10.157.1.0/24", "10.157.2.0/24"]
...
map_roles = [
  {
    rolearn = "arn:aws-cn:iam::817963804345:role/sc-china-cn-northwest-1-tf-codebuild-role-estate"
    username = "supercell-tf-codebuild-role-foundation"
    groups   = ["system:masters"]
  },
  {
    rolearn = "arn:aws-cn:iam::817963804345:role/cn-kube-dev-write"
...
map_users = [
  {
    userarn = "arn:aws-cn:iam::817963804345:user/ext-ejagyugya.nc"
    username = "ext-ejagyugya.nc"
    groups   = ["kubefoundation-ca"]
  },
  {
    userarn = "arn:aws-cn:iam::817963804345:user/ext-mstankevic.nc"
    username = "ext-mstankevic.cn"
    groups   = ["kubefoundation-ca"]
  },
  {
    userarn = "arn:aws-cn:iam::817963804345:user/ext-gergo.nagy"
    username = "ext-gergo.nagy"
    groups   = ["kubefoundation-ca"]
  },
  {
    userarn = "arn:aws-cn:iam::817963804345:user/ext-svc-account-mce.nc"
    username = "ext-svc-account-mce.nc"
    groups   = ["system:masters"]
  },
  {
    userarn = "arn:aws-cn:iam::817963804345:user/juho.arenius"
...
trusted_registries = [
  "817963804345.dkr.ecr.cn-northwest-1.amazonaws.com.cn",
