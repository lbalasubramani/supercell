...
variable "sc_groups_with_global_ns_listing_perms" {
  description = "Additional Supercell groups (for example supercell:developers) to be attached to cluster-wide role with ns listing permissions"
  type        = list
  default     = []
}
...
variable "cert_manager_repository" {
  ...
  type        = string
  default     = "https://github.com/supercell/kube-foundation"
}
